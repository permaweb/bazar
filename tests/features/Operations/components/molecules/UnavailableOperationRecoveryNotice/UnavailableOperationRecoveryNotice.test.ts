...
import UnavailableOperationRecoveryNotice from 'features/Operations/components/molecules/UnavailableOperationRecoveryNotice/UnavailableOperationRecoveryNotice';
...
describe('unavailable operation recovery notice', () => {
	it('blocks silent replacement while preserving the exact transaction and recovery choices', () => {
		...
		const markup = renderToStaticMarkup(
			React.createElement(UnavailableOperationRecoveryNotice, {
				recovery: {
