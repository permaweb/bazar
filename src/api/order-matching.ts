...
export function parseTokenAmount(value: string, denomination: number): string {
	...
	return (BigInt(whole) * scale + BigInt((fraction + '0'.repeat(denomination)).slice(0, denomination) || '0'))
		.toString();
}
 ...
 */
export function matchWholeOrders(
	orders: Iterable<SwapOrder>,
	requestedQuantity: string
): WholeOrderMatch | null {
