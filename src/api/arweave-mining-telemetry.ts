...
export function parseAcceptedBlockProof(value: unknown, observedAt = Date.now()): ArweaveAcceptedProof | undefined {
  ...
  return {
    ...
    ...(finiteNumber(block.replica_format) === undefined ? {} : { replicaFormat: finiteNumber(block.replica_format) }),
      ...
      return {
        ...
        ...(chunk
          ? {
              ...
              ...(chunk.absoluteEndOffset === undefined ? {} : { absoluteEndOffset: chunk.absoluteEndOffset }),
            }
          : {}),
        ...(source
          ? {
