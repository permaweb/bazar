...
export default function LatestCollectionsCarousel(props: IProps) {
	...
	// Only hide if we have no collections and we're not loading
	if (!props.collections && !props.loading) {
		return null;
	}
	...
	return (
		<S.Wrapper className={'fade-in'}>
			<S.Header>
				<h4>Latest</h4>
				<S.HeaderActions>
					<Button type={'primary'} label="View All Collections" handlePress={() => navigate(URLS.collections)} />
				</S.HeaderActions>
			</S.Header>
