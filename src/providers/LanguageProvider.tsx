...
const strings: Record<string, string> = {
	...
	transactionSyncForkDaily: 'Estimated reorg interval: 1 day',
	transactionSyncForkMonthly: 'Estimated reorg interval: 1 month',
	transactionSyncForkTwoYears: 'Estimated reorg interval: 2 years',
