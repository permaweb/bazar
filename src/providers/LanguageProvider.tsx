...
const strings: Record<string, string> = {
  ...
  transactionSyncProtocolTelemetry: 'Observer quorum',
  ...
  transactionSyncProtocolAgreement: 'Sampled observer agreement',
  ...
  transactionSyncMiningPinOffset: 'Offset {offset}',
