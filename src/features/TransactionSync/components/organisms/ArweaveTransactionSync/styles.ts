...
import { confirmationProgress, PROGRESS_GRADIENT, progressColorCss } from '../../../model/progressColors';
...
export const RiskNote = styled.p`
	...
	z-index: 2;
	margin: 7px 0 0;
	color: ${TRANSACTION_SEQUENCE_COLORS.riskNoteText};
	font-size: ${(props) => props.theme.typography.size.small};
`;
...
export const RaceTooltipStageDot = styled.i<LaneTrustProps>`
	...
	border: 1px solid ${TRANSACTION_SEQUENCE_COLORS.stageDotBorder};
	border-radius: 50%;
`;
