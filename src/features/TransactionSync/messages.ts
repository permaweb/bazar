...
export const TRANSACTION_SYNC_MESSAGES = defineMessages({
	en: {
		transaction: 'Transaction',
		transactionSyncCopyAddress: 'Copy transaction address',
		transactionSyncCopiedTooltip: 'Copied',
		transactionSyncCopiedAddress: 'Transaction address copied',
		transactionSyncCopiedAddressAnnouncement: 'Transaction address copied.',
		transactionSyncRacePrototypeInfinityCable: 'Network synchronization: {subject}',
		...
		transactionSyncConfirmationCount: { one: '{count} confirmation', other: '{count} confirmations' },
		transactionSyncConfirmationDepthOfTarget: '{depth} of {target}',
		transactionSyncConfirmations: 'confirmations',
		transactionSyncConfirmationProgress: '{label}: {depth} of {target} confirmations.',
		transactionSyncConfirmationProgressComplete: '{label}: {depth} of {target} confirmations complete.',
		transactionSyncSettlingLiveState: 'Settling live state',
		transactionSyncVisualizerObserverStatus: 'Live observer status',
		transactionSyncVisualizerUnavailable: '3D network view unavailable',
		transactionSyncVisualizerUnavailableDetail: 'Transaction tracking continues with live observer status.',
		transactionSyncRecallImage: 'Image',
		transactionSyncRecallImageLoading: 'Loading image preview',
		transactionSyncRecallTextSymbol: 'Aa',
		...
		transactionSyncSkipDetail:
			'The registration will keep confirming in the background while settlement continues.',
		...
		transactionSyncObserverSourceSeed: 'seed',
		transactionSyncObserverSourceLocal: 'local',
		transactionSyncObserverSourceHyperbeam: 'HyperBEAM',
		transactionSyncObserverSourcePeer: 'peer',
	},
});

export type TransactionSyncMessages = (typeof TRANSACTION_SYNC_MESSAGES)['en'];
